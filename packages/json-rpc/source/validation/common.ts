...
type Unbatched = Exclude<Message, ResponseBatch | ResponseBatch>

export function isBatch(message: Message): message is RequestBatch | ResponseBatch {
  return Array.isArray(message)
}

export const isJsonRpcV2 = (message: Message): message is Unbatched =>
  !isBatch(message) && message.jsonrpc === '2.0'
